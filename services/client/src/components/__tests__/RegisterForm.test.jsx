...
describe("handles form validation correctly", () => {
  ...
  // In this test, we assert that the Enter a valid email.
  // error is displayed when the email input field contains a value of invalid.
  ...
  // when fields are not the proper length:
