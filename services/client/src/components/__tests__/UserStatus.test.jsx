...
// In this test, we first used Jest to mock the third-party library Axios.
// Take note of the default return value which is a promise that resolves to an object.
// We then ensure that Axios is called once and that the DOM contains the proper text.
